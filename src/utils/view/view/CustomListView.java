...
//	private int footContentHeight;
	...
	private void init(Context context) {
		...
		lastUpdatedTextView.setText(R.string.pull_to_refresh_refresh_last_time);
		...
		Log.e("size", "width:" + headContentWidth + " height:" + headContentHeight);
	...
	public void first(){
		...
		loadMoreView.setText(getContext().getString(R.string.pull_to_refresh_refreshing_label));
	}

	private void onLoad() {
		if (loadListener != null) {
			moreProgressBar.setVisibility(View.VISIBLE);
			loadMoreView.setText(getContext().getString(R.string.loading_label));
			loadListener.onLoad();
		}
	}
