package utils.view.pull;

import android.content.Context;
import android.media.MediaPlayer;
import utils.music.OnPullEventListener;
 ...
 */
public class SoundPullListener implements OnPullEventListener {
	 ...
	 */
	public SoundPullListener(Context context) {
		mContext = context;
